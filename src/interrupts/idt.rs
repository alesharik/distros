...
int_handler!(divide_error_handler |stack_frame: InterruptStackFrame| {
    println!("EXCEPTION: DIVIDE ERROR\n{:#?}", stack_frame);
});

int_handler!(overflow_handler |stack_frame: InterruptStackFrame| {
    println!("EXCEPTION: OVERFLOW\n{:#?}", stack_frame);
});

int_handler!(bound_handler |stack_frame: InterruptStackFrame| {
    println!("EXCEPTION: BOUND RANGE EXCEEDED\n{:#?}", stack_frame);
});

int_handler!(invalid_opcode |stack_frame: InterruptStackFrame| {
    println!("EXCEPTION: INVALID OPCODE\n{:#?}", stack_frame);
});

int_handler!(device_not_available |stack_frame: InterruptStackFrame| {
